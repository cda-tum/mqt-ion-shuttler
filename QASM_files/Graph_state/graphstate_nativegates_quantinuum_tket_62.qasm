...
rx(0.5*pi) q[44];
rx(0.5*pi) q[47];
rzz(0.5*pi) q[48],q[56];
rx(0.5*pi) q[51];
rx(0.5*pi) q[52];
rzz(0.5*pi) q[54],q[61];
rx(0.5*pi) q[55];
rz(0.5*pi) q[0];
rx(0.5*pi) q[1];
rz(0.5*pi) q[2];
