...
rzz(0.5*pi) q[8],q[21];
rz(0.5*pi) q[9];
rzz(0.5*pi) q[10],q[48];
rz(0.5*pi) q[11];
rzz(0.5*pi) q[15],q[32];
rz(0.5*pi) q[16];
rzz(0.5*pi) q[17],q[66];
rz(0.5*pi) q[18];
rz(0.5*pi) q[20];
rzz(0.5*pi) q[23],q[42];
rz(0.5*pi) q[24];
rzz(0.5*pi) q[26],q[61];
rz(0.5*pi) q[27];
rzz(0.5*pi) q[33],q[60];
rz(0.5*pi) q[34];
rzz(0.5*pi) q[39],q[56];
rz(0.5*pi) q[40];
rx(0.5*pi) q[0];
rzz(0.5*pi) q[1],q[30];
rx(0.5*pi) q[2];
...
rzz(0.5*pi) q[22],q[63];
rx(0.5*pi) q[29];
rzz(0.5*pi) q[38],q[43];
rz(0.5*pi) q[45];
rz(0.5*pi) q[47];
rz(0.5*pi) q[51];
rz(0.5*pi) q[53];
