...
rz(0.5*pi) q[12];
rzz(0.5*pi) q[13],q[43];
rz(0.5*pi) q[14];
rzz(0.5*pi) q[15],q[57];
rz(0.5*pi) q[16];
rzz(0.5*pi) q[18],q[26];
rz(0.5*pi) q[19];
rzz(0.5*pi) q[21],q[56];
rz(0.5*pi) q[22];
rzz(0.5*pi) q[24],q[46];
rz(0.5*pi) q[25];
rzz(0.5*pi) q[28],q[59];
rz(0.5*pi) q[29];
rzz(0.5*pi) q[34],q[67];
rz(0.5*pi) q[35];
rx(0.5*pi) q[0];
rzz(0.5*pi) q[1],q[38];
rx(0.5*pi) q[2];
...
rx(0.5*pi) q[26];
rx(0.5*pi) q[28];
rzz(0.5*pi) q[29],q[58];
rx(0.5*pi) q[34];
rzz(0.5*pi) q[35],q[48];
rx(0.5*pi) q[36];
rx(0.5*pi) q[39];
rx(0.5*pi) q[43];
rx(0.5*pi) q[46];
...
rx(0.5*pi) q[9];
rx(0.5*pi) q[10];
rzz(0.5*pi) q[17],q[55];
rz(0.5*pi) q[19];
rz(0.5*pi) q[20];
rzz(0.5*pi) q[23],q[40];
rx(0.5*pi) q[30];
rx(0.5*pi) q[31];
...
rx(0.5*pi) q[38];
rx(0.5*pi) q[39];
rzz(0.5*pi) q[44],q[56];
rz(0.5*pi) q[45];
rz(0.5*pi) q[46];
rzz(0.5*pi) q[47],q[63];
rx(0.5*pi) q[49];
rx(0.5*pi) q[50];
rx(0.5*pi) q[53];
rx(0.5*pi) q[57];
