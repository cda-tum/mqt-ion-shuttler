...
rz(0.5*pi) q[11];
rzz(0.5*pi) q[12],q[63];
rz(0.5*pi) q[13];
rzz(0.5*pi) q[14],q[22];
rz(0.5*pi) q[15];
rzz(0.5*pi) q[18],q[32];
rz(0.5*pi) q[19];
rzz(0.5*pi) q[20],q[68];
rz(0.5*pi) q[21];
rzz(0.5*pi) q[34],q[52];
rz(0.5*pi) q[35];
rzz(0.5*pi) q[37],q[64];
rz(0.5*pi) q[38];
rzz(0.5*pi) q[40],q[56];
rz(0.5*pi) q[41];
rzz(0.5*pi) q[50],q[59];
rz(0.5*pi) q[51];
rx(0.5*pi) q[0];
rzz(0.5*pi) q[1],q[26];
rx(0.5*pi) q[2];
...
rx(0.5*pi) q[20];
rzz(0.5*pi) q[21],q[57];
rx(0.5*pi) q[22];
rx(0.5*pi) q[24];
rx(0.5*pi) q[32];
rx(0.5*pi) q[34];
rzz(0.5*pi) q[35],q[45];
rx(0.5*pi) q[36];
rx(0.5*pi) q[37];
rzz(0.5*pi) q[38],q[47];
rx(0.5*pi) q[39];
rx(0.5*pi) q[40];
