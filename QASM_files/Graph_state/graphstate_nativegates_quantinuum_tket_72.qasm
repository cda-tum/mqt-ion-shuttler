...
rx(0.5*pi) q[19];
rx(0.5*pi) q[23];
rzz(0.5*pi) q[24],q[54];
rzz(0.5*pi) q[30],q[66];
rx(0.5*pi) q[31];
rzz(0.5*pi) q[32],q[45];
rx(0.5*pi) q[33];
rx(0.5*pi) q[35];
rzz(0.5*pi) q[39],q[46];
rzz(0.5*pi) q[43],q[50];
rx(0.5*pi) q[49];
rx(0.5*pi) q[53];
rx(0.5*pi) q[56];
