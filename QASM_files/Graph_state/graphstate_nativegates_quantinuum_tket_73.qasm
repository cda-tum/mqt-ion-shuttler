...
rzz(0.5*pi) q[8],q[43];
rz(0.5*pi) q[9];
rzz(0.5*pi) q[10],q[71];
rz(0.5*pi) q[11];
rzz(0.5*pi) q[12],q[42];
rz(0.5*pi) q[13];
...
rx(0.5*pi) q[12];
rx(0.5*pi) q[14];
rzz(0.5*pi) q[15],q[55];
rx(0.5*pi) q[16];
rx(0.5*pi) q[18];
rx(0.5*pi) q[20];
rzz(0.5*pi) q[21],q[48];
rx(0.5*pi) q[22];
...
rz(0.5*pi) q[59];
rz(0.5*pi) q[6];
rzz(0.5*pi) q[13],q[59];
rx(0.5*pi) q[17];
rx(0.5*pi) q[19];
rz(0.5*pi) q[26];
rz(0.5*pi) q[27];
rz(0.5*pi) q[29];
rzz(0.5*pi) q[31],q[55];
rx(0.5*pi) q[32];
rx(0.5*pi) q[33];
rx(0.5*pi) q[35];
...
rz(0.5*pi) q[30];
rz(0.5*pi) q[37];
rzz(0.5*pi) q[39],q[66];
rzz(0.5*pi) q[44],q[60];
rx(0.5*pi) q[46];
rz(0.5*pi) q[49];
rz(0.5*pi) q[57];
rz(0.5*pi) q[62];
rx(0.5*pi) q[72];
rzz(0.5*pi) q[7],q[61];
rzz(0.5*pi) q[28],q[64];
rzz(0.5*pi) q[30],q[69];
rzz(0.5*pi) q[37],q[63];
rx(0.5*pi) q[39];
rx(0.5*pi) q[44];
rz(0.5*pi) q[46];
rzz(0.5*pi) q[49],q[53];
rx(0.5*pi) q[57];
rx(0.5*pi) q[60];
rx(0.5*pi) q[62];
rx(0.5*pi) q[66];
