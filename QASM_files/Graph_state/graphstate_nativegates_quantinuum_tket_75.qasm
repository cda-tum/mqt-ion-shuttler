...
rx(0.5*pi) q[20];
rzz(0.5*pi) q[21],q[50];
rx(0.5*pi) q[22];
rx(0.5*pi) q[23];
rx(0.5*pi) q[25];
rzz(0.5*pi) q[26],q[63];
rx(0.5*pi) q[29];
rx(0.5*pi) q[30];
...
rzz(0.5*pi) q[29],q[71];
rzz(0.5*pi) q[34],q[42];
rzz(0.5*pi) q[35],q[36];
rx(0.5*pi) q[37];
rzz(0.5*pi) q[39],q[64];
rx(0.5*pi) q[40];
rx(0.5*pi) q[41];
rx(0.5*pi) q[43];
rz(0.5*pi) q[44];
