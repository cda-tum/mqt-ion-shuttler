...
rx(0.5*pi) q[13];
rzz(0.5*pi) q[14],q[71];
rx(0.5*pi) q[15];
rzz(0.5*pi) q[16],q[39];
rx(0.5*pi) q[17];
rx(0.5*pi) q[18];
rx(0.5*pi) q[19];
rzz(0.5*pi) q[20],q[44];
...
rx(0.5*pi) q[34];
rx(0.5*pi) q[40];
rzz(0.5*pi) q[41],q[58];
rzz(0.5*pi) q[46],q[59];
rx(0.5*pi) q[48];
rx(0.5*pi) q[61];
rx(0.5*pi) q[63];
rx(0.5*pi) q[64];
...
rx(0.5*pi) q[45];
rzz(0.5*pi) q[48],q[76];
rzz(0.5*pi) q[52],q[53];
rz(0.5*pi) q[58];
rz(0.5*pi) q[59];
rzz(0.5*pi) q[61],q[74];
rx(0.5*pi) q[63];
rzz(0.5*pi) q[64],q[65];
rz(0.5*pi) q[70];
rzz(0.5*pi) q[12],q[68];
rx(0.5*pi) q[17];
rx(0.5*pi) q[18];
rx(0.5*pi) q[21];
rz(0.5*pi) q[23];
...
rx(0.5*pi) q[52];
rx(0.5*pi) q[53];
rzz(0.5*pi) q[58],q[71];
rzz(0.5*pi) q[59],q[60];
rx(0.5*pi) q[61];
rz(0.5*pi) q[63];
rx(0.5*pi) q[64];
rx(0.5*pi) q[65];
rzz(0.5*pi) q[70],q[75];
rx(0.5*pi) q[74];
rx(0.5*pi) q[76];
rx(0.5*pi) q[12];
rz(0.5*pi) q[17];
...
rz(0.5*pi) q[36];
rx(0.5*pi) q[37];
rzz(0.5*pi) q[38],q[67];
rzz(0.5*pi) q[43],q[62];
rzz(0.5*pi) q[52],q[54];
rx(0.5*pi) q[56];
rz(0.5*pi) q[58];
rz(0.5*pi) q[59];
rx(0.5*pi) q[60];
