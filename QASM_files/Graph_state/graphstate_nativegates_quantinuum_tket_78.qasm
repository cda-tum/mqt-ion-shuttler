...
rz(0.5*pi) q[21];
rzz(0.5*pi) q[23],q[57];
rz(0.5*pi) q[24];
rz(0.5*pi) q[37];
rzz(0.5*pi) q[39],q[63];
rz(0.5*pi) q[40];
rz(0.5*pi) q[45];
rzz(0.5*pi) q[46],q[64];
rz(0.5*pi) q[47];
rzz(0.5*pi) q[52],q[77];
rz(0.5*pi) q[53];
...
rzz(0.5*pi) q[19],q[60];
rx(0.5*pi) q[20];
rzz(0.5*pi) q[21],q[59];
rx(0.5*pi) q[22];
rx(0.5*pi) q[23];
rx(0.5*pi) q[27];
rx(0.5*pi) q[29];
...
rz(0.5*pi) q[37];
rz(0.5*pi) q[40];
rzz(0.5*pi) q[44],q[67];
rzz(0.5*pi) q[45],q[63];
rz(0.5*pi) q[48];
rz(0.5*pi) q[50];
rz(0.5*pi) q[51];
rz(0.5*pi) q[53];
