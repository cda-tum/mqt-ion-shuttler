...
rz(0.5*pi) q[20];
rz(0.5*pi) q[30];
rzz(0.5*pi) q[31],q[66];
rz(0.5*pi) q[32];
rzz(0.5*pi) q[38],q[58];
rz(0.5*pi) q[39];
rzz(0.5*pi) q[48],q[78];
rz(0.5*pi) q[49];
rzz(0.5*pi) q[51],q[77];
rz(0.5*pi) q[52];
rz(0.5*pi) q[60];
rz(0.5*pi) q[68];
rx(0.5*pi) q[0];
...
rx(0.5*pi) q[19];
rzz(0.5*pi) q[20],q[64];
rx(0.5*pi) q[23];
rx(0.5*pi) q[26];
rx(0.5*pi) q[27];
rzz(0.5*pi) q[30],q[62];
rx(0.5*pi) q[31];
rx(0.5*pi) q[36];
rx(0.5*pi) q[37];
rx(0.5*pi) q[38];
...
rz(0.5*pi) q[65];
rz(0.5*pi) q[70];
rzz(0.5*pi) q[18],q[71];
rzz(0.5*pi) q[22],q[34];
rx(0.5*pi) q[24];
rx(0.5*pi) q[25];
rx(0.5*pi) q[28];
rzz(0.5*pi) q[41],q[61];
