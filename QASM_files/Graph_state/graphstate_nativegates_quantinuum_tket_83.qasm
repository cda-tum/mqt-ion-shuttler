...
rz(0.5*pi) q[25];
rz(0.5*pi) q[28];
rzz(0.5*pi) q[29],q[64];
rz(0.5*pi) q[30];
rzz(0.5*pi) q[33],q[59];
rz(0.5*pi) q[34];
rz(0.5*pi) q[36];
rz(0.5*pi) q[39];
rzz(0.5*pi) q[41],q[56];
rz(0.5*pi) q[42];
rzz(0.5*pi) q[49],q[74];
rz(0.5*pi) q[50];
rzz(0.5*pi) q[66],q[68];
rz(0.5*pi) q[67];
rx(0.5*pi) q[0];
rzz(0.5*pi) q[1],q[51];
rzz(0.5*pi) q[3],q[72];
...
rx(0.5*pi) q[20];
rzz(0.5*pi) q[21],q[77];
rx(0.5*pi) q[23];
rzz(0.5*pi) q[25],q[45];
rx(0.5*pi) q[26];
rzz(0.5*pi) q[28],q[61];
rx(0.5*pi) q[29];
rzz(0.5*pi) q[30],q[82];
rx(0.5*pi) q[33];
rzz(0.5*pi) q[36],q[63];
rx(0.5*pi) q[37];
rzz(0.5*pi) q[39],q[62];
rx(0.5*pi) q[41];
rzz(0.5*pi) q[42],q[60];
rx(0.5*pi) q[44];
rx(0.5*pi) q[46];
rx(0.5*pi) q[49];
rx(0.5*pi) q[54];
...
rx(0.5*pi) q[44];
rz(0.5*pi) q[45];
rzz(0.5*pi) q[46],q[48];
rzz(0.5*pi) q[50],q[63];
rz(0.5*pi) q[51];
rx(0.5*pi) q[53];
rx(0.5*pi) q[54];
rzz(0.5*pi) q[56],q[57];
rz(0.5*pi) q[60];
rzz(0.5*pi) q[67],q[77];
rzz(0.5*pi) q[68],q[72];
rx(0.5*pi) q[69];
rz(0.5*pi) q[70];
rx(0.5*pi) q[78];
rx(0.5*pi) q[79];
