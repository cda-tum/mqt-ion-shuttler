...
rz(0.5*pi) q[13];
rzz(0.5*pi) q[14],q[80];
rz(0.5*pi) q[15];
rz(0.5*pi) q[18];
rzz(0.5*pi) q[21],q[64];
rz(0.5*pi) q[22];
rzz(0.5*pi) q[23],q[70];
rz(0.5*pi) q[24];
rzz(0.5*pi) q[29],q[63];
rz(0.5*pi) q[30];
rzz(0.5*pi) q[32],q[34];
rz(0.5*pi) q[33];
rzz(0.5*pi) q[35],q[58];
rz(0.5*pi) q[36];
rzz(0.5*pi) q[37],q[62];
rz(0.5*pi) q[38];
rzz(0.5*pi) q[40],q[61];
rz(0.5*pi) q[41];
rz(0.5*pi) q[66];
rx(0.5*pi) q[0];
rzz(0.5*pi) q[1],q[39];
...
rzz(0.5*pi) q[9],q[28];
rx(0.5*pi) q[10];
rzz(0.5*pi) q[11],q[72];
rx(0.5*pi) q[12];
rzz(0.5*pi) q[13],q[25];
rx(0.5*pi) q[14];
rzz(0.5*pi) q[15],q[48];
rzz(0.5*pi) q[18],q[26];
rx(0.5*pi) q[20];
rx(0.5*pi) q[21];
rzz(0.5*pi) q[22],q[57];
rx(0.5*pi) q[23];
rzz(0.5*pi) q[24],q[67];
rx(0.5*pi) q[29];
rzz(0.5*pi) q[30],q[56];
rx(0.5*pi) q[31];
rx(0.5*pi) q[32];
...
rzz(0.5*pi) q[31],q[60];
rzz(0.5*pi) q[34],q[52];
rz(0.5*pi) q[39];
rzz(0.5*pi) q[44],q[51];
rz(0.5*pi) q[45];
rz(0.5*pi) q[47];
rz(0.5*pi) q[56];
rzz(0.5*pi) q[58],q[59];
rzz(0.5*pi) q[61],q[62];
rzz(0.5*pi) q[64],q[70];
rz(0.5*pi) q[67];
...
rz(0.5*pi) q[20];
rx(0.5*pi) q[25];
rzz(0.5*pi) q[26],q[77];
rx(0.5*pi) q[27];
rx(0.5*pi) q[28];
rx(0.5*pi) q[31];
rx(0.5*pi) q[34];
rzz(0.5*pi) q[39],q[74];
rx(0.5*pi) q[44];
