...
rz(0.5*pi) q[12];
rzz(0.5*pi) q[13],q[62];
rz(0.5*pi) q[14];
rzz(0.5*pi) q[16],q[51];
rz(0.5*pi) q[17];
rzz(0.5*pi) q[19],q[55];
rz(0.5*pi) q[20];
rzz(0.5*pi) q[35],q[76];
rz(0.5*pi) q[36];
rzz(0.5*pi) q[37],q[63];
rz(0.5*pi) q[38];
rzz(0.5*pi) q[41],q[74];
rz(0.5*pi) q[42];
rzz(0.5*pi) q[43],q[72];
rz(0.5*pi) q[44];
rzz(0.5*pi) q[56],q[59];
rz(0.5*pi) q[57];
rx(0.5*pi) q[0];
rzz(0.5*pi) q[1],q[67];
rx(0.5*pi) q[2];
...
rz(0.5*pi) q[77];
rz(0.5*pi) q[85];
rzz(0.5*pi) q[10],q[47];
rzz(0.5*pi) q[15],q[45];
rzz(0.5*pi) q[18],q[61];
...
rz(0.5*pi) q[48];
rz(0.5*pi) q[50];
rzz(0.5*pi) q[51],q[60];
rx(0.5*pi) q[54];
rx(0.5*pi) q[55];
rzz(0.5*pi) q[62],q[63];
rzz(0.5*pi) q[66],q[67];
rzz(0.5*pi) q[72],q[74];
rx(0.5*pi) q[10];
rx(0.5*pi) q[15];
rx(0.5*pi) q[18];
rx(0.5*pi) q[21];
...
rz(0.5*pi) q[64];
rx(0.5*pi) q[65];
rzz(0.5*pi) q[66],q[75];
rx(0.5*pi) q[68];
rx(0.5*pi) q[69];
rx(0.5*pi) q[21];
rz(0.5*pi) q[24];
rx(0.5*pi) q[25];
rzz(0.5*pi) q[29],q[53];
rz(0.5*pi) q[30];
rx(0.5*pi) q[32];
rz(0.5*pi) q[34];
rzz(0.5*pi) q[45],q[73];
rzz(0.5*pi) q[46],q[64];
...
rz(0.5*pi) q[75];
rz(0.5*pi) q[77];
rzz(0.5*pi) q[79],q[84];
rzz(0.5*pi) q[80],q[82];
rx(0.5*pi) q[85];
rx(0.5*pi) q[86];
rx(0.5*pi) q[39];
rx(0.5*pi) q[48];
